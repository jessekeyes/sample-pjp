  ...
  if (isset($_ENV['PANTHEON_ENVIRONMENT'])):
    ...
    if (isset($_SERVER['HTTP_HOST'])) {
        ...
        if ($_ENV['PANTHEON_ENVIRONMENT'] === 'dev'):
          $domain = 'dev-japanesegarden.pantheonsite.io';
          $scheme = 'https';
        elseif ($_ENV['PANTHEON_ENVIRONMENT'] === 'test'):
          $domain = 'test-japanesegarden.pantheonsite.io';
          $scheme = 'https';
        elseif ($_ENV['PANTHEON_ENVIRONMENT'] === 'live'):
          $domain = 'japanesegarden.org';
          $scheme = 'https';
        endif;
        ...
        if (isset($_SERVER['PANTHEON_ENVIRONMENT']) &&
          ...
          if ($_SERVER['HTTP_HOST'] != $domain ||
            ...
            header('Location: ' . $scheme . '://' . $domain . $_SERVER['REQUEST_URI']);
            exit();
          }
        }
    ...
    if ( $_ENV['PANTHEON_ENVIRONMENT'] == 'dev' ) :
        ...
        define( 'BASIC_AUTH_USERNAME', 'tf4tt' );
        define( 'BASIC_AUTH_PASSWORD', 'garden' );
        //jetpack dev
...
// recaptcha
define( 'RECAPTCHA_PUBLIC_KEY', '6LeWJTsUAAAAAPTSX9XZMinG0Qi3VpXrzzzAOEEQ' );
define( 'RECAPTCHA_PRIVATE_KEY', '6LeWJTsUAAAAAKukiylhGEMXEIWCPoh5U64PbucX' );
