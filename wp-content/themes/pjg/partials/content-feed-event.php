...
// template for dynamic content feed, event post type
...
<div class="dynamic-content-feed-rows <?= $feed_type; ?> multiple">
    ...
    <div class="dynamic-content-feed-header show">
        <div class="headline"><?= $feed_headline; ?>
          ...
          if( $count_class == 'multiple' ) { $view_all_link = ( $category ) ? get_category_link($category) . '?post_type=event' : '/events/'; ?>
              / <span class="view-all"><a href="<?= $view_all_link; ?>"><?= ($view_all_copy) ? $view_all_copy : 'View All Events'; ?></a></span>
          <?php } ?>
...
while ($posts->have_posts()) : $posts->the_post();
    ...
    <div class="dynamic-content-feed-row <?= $feed_type; ?> multiple">
        ...
        <div class="entry-header-wrapper">
          ...
          <div class="entry-meta"><?php echo pjg_posted_on( 'event', true );?></div>
